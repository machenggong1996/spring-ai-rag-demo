...
import static com.example.demo.milvus.Constants.CLUSTER_ENDPOINT;
...
public class CreateDatabase {
    ...
    public static void main(String[] args) {
        ...
        //upsertEntity(client);
        upsertEntityInPartitions(client);
    }

    public static void deleteEntity(MilvusClientV2 client){
        // 通过过滤器删除
    ...
    public static void upsertEntityInPartitions(MilvusClientV2 client){
    ...
    public static void upsertEntity(MilvusClientV2 client){
        List<JSONObject> data = Arrays.asList(
    ...
    public static void insertPartitions(MilvusClientV2 client){
// 4. Insert some more data into a specific partition
    ...
    public static void insertEntity(MilvusClientV2 client){
// 3. Insert some data
        List<JSONObject> data = Arrays.asList(
